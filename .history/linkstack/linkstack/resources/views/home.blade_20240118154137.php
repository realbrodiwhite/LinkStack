...
<!--#### BEGIN Meta Tags social media preview images  ####-->
  <!-- This shows a preview for title, description and avatar image of users profiles if shared on social media sites -->
    ...
    <meta property="og:image" content="{{ asset('assets/liinkmee/images/'.findFile('avatar')) }}">
    @else
    <meta property="og:image" content="{{ asset('assets/liinkmee/images/logo.svg') }}">
    @endif
    ...
    @if(file_exists(base_path("assets/liinkmee/images/").findFile('avatar')))
    <meta name="twitter:image" content="{{ asset('assets/liinkmee/images/'.findFile('avatar')) }}">
    @else
    <meta name="twitter:image" content="{{ asset('assets/liinkmee/images/logo.svg') }}">
    @endif
            ...
            <div class="card card-transparent auth-card shadow-none d-flex mb-0">
              <div class="card-body justify-content-center text-center">
                ...
                <div class="logo-container fadein">
                  <img src="{{ asset('assets/liinkmee/images/logo-animated.svg') }}" alt="Logo" style="width:150px; height:150px;">
                </div>
                @endif
