...
<html>
  <head>
    ...
    @endphp
      ...
      <!-- Favicon -->
      @if(file_exists(base_path("assets/liinkmee/images/").findFile('favicon')))
      <link rel="icon" type="image/png" href="{{ asset('assets/liinkmee/images/'.findFile('favicon')) }}">
      @else
      <link rel="icon" type="image/svg+xml" href="{{ asset('assets/liinkmee/images/logo.svg') }}">
      @endif
	  ...
	  <link rel="stylesheet" href="{{ asset('assets/liinkmee/css/hover-min.css') }}">
	  <link rel="stylesheet" href="{{ asset('assets/liinkmee/css/animate.css') }}">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="{{ route('panelIndex') }}" class="navbar-brand">
                ...
                <div class="logo-normal">
                  <img class="img logo" src="{{ asset('assets/liinkmee/images/'.findFile('avatar')) }}" style="width:auto;height:30px;">
              </div>
              <div class="logo-mini">
                <img class="img logo" src="{{ asset('assets/liinkmee/images/'.findFile('avatar')) }}" style="width:auto;height:30px;">
              </div>
                @else
                <div class="logo-normal">
                  <img class="img logo" type="image/svg+xml" src="{{ asset('assets/liinkmee/images/logo.svg') }}" width="30px" height="30px">
              </div>
              <div class="logo-mini">
                <img class="img logo" type="image/svg+xml" src="{{ asset('assets/liinkmee/images/logo.svg') }}" width="30px" height="30px">
              </div>
      ...
      <div class="position-relative iq-banner">
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
              ...
              <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                ...
                <li class="nav-item dropdown">
                  <a href="#"  class="nav-link" id="notification-drop" data-bs-toggle="dropdown" >
                      <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @if($GLOBALS['activenotify'])<circle cx="17" cy="17" r="5" fill="#32CD32" stroke="white" stroke-width="2"/>@endif
                      </svg>
                ...
                @if(env('NOTIFY_UPDATES') == 'true' or env('NOTIFY_UPDATES') === 'major' or env('NOTIFY_UPDATES') === 'all')
                              ...
                              @if(file_exists(base_path("version.json")))
                                ...
                                try{
                                $Vgit = external_file_get_contents("https://version.liinkmee.org/"); 
                                      ...
                                      <table class="m-0 table table-bordered table-sm">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td><center><span class="badge rounded-pill bg-primary"><?php echo external_file_get_contents("https://beta.liinkmee.org/vbeta.json"); ?></span></center></td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </div>
          ...
          <img src="{{ url("assets/liinkmee/images/")."/".findFile('avatar') }}" alt="User-Profile" class="img logo" style="width:auto;height:30px;">
					@else
					<img src="{{ asset('assets/liinkmee/images/logo.svg') }}" alt="User-Profile" class="img-fluid avatar avatar-40 avatar-rounded">
					@endif
          ...
          <div class="footer-body">
              ...
              <div class="right-panel">
                ...
                @if(env('DISPLAY_CREDIT_FOOTER') === true)
                  ...
                  </span> {{__('messages.by')}} <a href="https://liinkmee.org/" target="_blank">Liinkmee</a>.
                @endif
              </div>
          </div>
      </footer>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              try {
                ...
                $imgSrc = url('/assets/liinkmee/images/themes/no-preview.png');
                $imgType = NULL;
              }
              @endphp
