                  ...
                  <div class="col-sm-12">  
                    ...
                    <form action="{{ route('themeBackground') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group col-lg-8">
                            ...
                            <img class="bd-placeholder-img figure-img img-fluid rounded" src="@if(file_exists(base_path('assets/img/background-img/'.findBackground(Auth::user()->id)))){{url('assets//img/background-img/'.findBackground(Auth::user()->id))}}@else{{url('/assets/liinkmee/images/themes/no-preview.png')}}@endif"><br>
                           ...
                           <div class="card-body pb-0">
                            <a style="cursor:pointer;" onclick="setTheme('default')">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    <img draggable="false" class="bd-placeholder-img bd-placeholder-img-lg img-fluid" src="{{url('assets/liinkmee/images/themes/default.png')}}">
                                 </div>
                              </div>
