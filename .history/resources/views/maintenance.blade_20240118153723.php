...
<link rel="stylesheet" href="{{ asset('assets/external-dependencies/fontawesome.css') }}" />
  ...
  <link rel="stylesheet" href="{{ asset('assets/liinkmee/css/skeleton-dark.css') }}">
  @elseif ($color_scheme_override == 'light')
  <link rel="stylesheet" href="{{ asset('assets/liinkmee/css/skeleton-light.css') }}">
  ...
  <style>@font-face{font-family:'ll';src:url({{ asset('assets/liinkmee/fonts/littlelink-custom.otf') }}) format("opentype")}</style>
...
<div class="containerr" style="">
      <div class="column">
        ...
        <img alt="avatar" src="{{ asset('assets/liinkmee/images/'.findFile('avatar')) }}" width="auto" height="200px">
        @else
        <div class="logo-container">
           <img src="{{ asset('assets/liinkmee/images/logo.svg') }}" alt="Logo" style="width:200px; height:200px;">
        </div>
        @endif
