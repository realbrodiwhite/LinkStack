    ...
    @php
        $notifications = [
            ...
            [
                ...
                'title' => __('messages.Enjoying Liinkmee?'),
...
notification('hide-star-notification', 'modal-star', __('messages.Support Liinkmee'), ''.__('messages.support.msg1').' <a target="_blank" href="https://github.com/linkstackorg/liinkmee">'.__('messages.support.msg2').'</a>. '.__('messages.support.msg3').'<br><br>'.__('messages.support.msg4').' <a target="_blank" href="https://liinkmee.org/donate">'.__('messages.support.msg5').'<br><br>'.__('messages.support.msg6').'');
@endphp @endpush
