...
return array (
  ...
  'by' => 'от',
  'HOME.MESSAGE' => '<p>Поемете контрол над онлайн присъствието си с <a href="https://LiinkMee.org/"><strong>LiinkMee</strong></a>
  ...
  'SMTP.description' => 'Използва SMTP сървър, предоставен от LiinkMee. Може да не е 100% надежден. Трябва да се деактивира, за да се използва персонализиран SMTP сървър.',
  ...
  'JOIN_BETA.description' => 'Позволява използването на бета версии при актуализиране. Прочетете повече за това <a target=\'_blank\' href=\'https://liinkmee.org/b\'>тук</a>.',
  ...
  'ENABLE_SOCIAL_LOGIN.description' => 'Позволява социално влизане. Тази опция изисква допълнителна настройка. Прочетете повече за това <a target=\'_blank\' href=\'https://liinkmee.org/social-login\'>тук</a>.',
  ...
  'LiinkMee setup' => 'Настройка на LiinkMee',
  'Setup LiinkMee' => 'Настройте LiinkMee',
  'Welcome to the setup for LiinkMee!' => 'Добре дошли в настройката за LiinkMee!',
  ...
  'Update LiinkMee' => 'Актуализирайте LiinkMee',
  ...
  'Learn more about LiinkMee' => 'Научете повече за LiinkMee',
  ...
  'Enjoying LiinkMee?' => 'Радвате ли се на LiinkMee?',
  'Support LiinkMee' => 'Поддръжка на LiinkMee',
  'support.msg1' => 'Ако обичате да използвате LiinkMee, ще сме много благодарни, ако можете да отделите малко време',
  ...
  'support.msg5' => 'направите финансов принос</a>, дори малка сума ще ни помогне да покрием разходите за поддръжка и подобряване на LiinkMee.',
  'support.msg6' => 'Благодарим ви за подкрепата и за това, че сте част от общността на LiinkMee!',
  'footer.Home' => 'Начало',
