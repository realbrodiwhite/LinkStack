...
|--------------------------------------------------------------------------
|
| Add external analytics services to your Liinkmee instance by adding them below.
...
'version' => '2.1',
    ...
    | These tags will only be applied to the home page or if a Liinkmee page 
    ...
    */
    ...
    'title'           => '', // Overrides the default meta page title. Leave empty to use your Liinkmee page title as the title.
    'description'     => '', // Overrides the default meta page description. Leave empty to use your Liinkmee page description as the description.
    'robots'          => 'index,follow',
    ...
    */
    ...
    // Overwrites default page title after the Liinkmee name on Liinkmee pages.
    // Example: "admin 🔗 Liinkmee"
    //                 ⤌----------⤍
    ...
    */
    ...
    // The URL prefix is the symbol that comes before a Liinkmee URL.
    ...
    */
    ...
    | This allows you to add your own icons to 'custom' buttons. You can find a list of available icons on liinkmee.org/fa.
    | 
    ...
    */
    ...
    'buttons' => array(
      array(
        'button' => 'github',
        'link' => 'https://github.com/linkstackorg/liinkmee',
        'title' => 'GitHub',
        'icon' => '',
        'custom_css' => ''
      ),
      ...
      array(
        'button' => 'custom',
        'link' => 'https://liinkmee.org/donate',
        'title' => 'Help us out',
