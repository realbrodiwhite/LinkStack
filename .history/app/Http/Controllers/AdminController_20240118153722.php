...
public function SendTestMail(Request $request)
{
    ...
    public function editSite(request $request)
    {
        ...
        if (!empty($logo)) {
            ...
            $path = base_path('/assets/liinkmee/images/'.$path);
            ...
            $logo->move(base_path('/assets/liinkmee/images/'), "avatar" . '_' . time() . "." .$request->file('image')->extension());
        }
        ...
        if (!empty($icon)) {
            ...
            $icon->move(base_path('/assets/liinkmee/images/'), "favicon" . '_' . time() . "." . $request->file('icon')->extension());
        }
        return back();
    }
